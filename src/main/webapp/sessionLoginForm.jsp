...
<link href="assets/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <style>
      ...
      .navbar {
        background-color: #f8f9fa; /* 배경색을 회색 조금 낀 흰색으로 변경 */
    }
    .navbar-nav .nav-link {
        color: #6c757d; /* 네비게이션 링크 텍스트 색상을 회색으로 변경 */
    }
    </style>
...
<main class="form-signin w-100 m-auto">
  <form action="<%= request.getContextPath() %>/sessionLogin.jsp"
      method="post">
    <img class="mb-4" src="assets/brand/apple.svg" alt="" width="72" height="57">
    ...
    <p class="mt-3 mb-0 text-body-secondary">계정이 없으신가요? <a href="memberForm.jsp">회원가입</a></p>
